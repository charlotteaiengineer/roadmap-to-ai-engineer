...
(function(){
  ...
  function cardHTML(d) {
    ...
    a.innerHTML = `
      <img loading="lazy" src="${d.image}" alt="${d.title}" style="width:100%;height:auto;" onerror="this.onerror=null;this.src='https://via.placeholder.com/600x900?text=No+Image'">
      <div class="meta">
